...
*대본 하나, 화풍 다섯 가지. 위의 모든 프레임은 코드로 그렸습니다.*
...
5. **넘기기 전에 검수합니다.** 최종 렌더 전에 스틸, 전환 구간, 전체 타임라인, 음량(-14 LUFS)을 확인합니다.
...
자체 제작 화풍 다섯 개는 같은 장면 API를 써서, 대본 하나를 어느 화풍으로든 렌더할 수 있습니다. 아래는 같은 "단계" 장면을 다섯 화풍으로 그린 모습입니다.
